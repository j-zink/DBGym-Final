...
CREATE TABLE trainer_session(
    ...
    FOREIGN KEY
(trainer_id) REFERENCES employee
(employee_id),
    FOREIGN KEY
(member_id) REFERENCES members
(member_id)
...
`, `birth_date`, `phone_num`, `membership_type`, `dependents`)
VALUES
("Joe", "Zink", "2001-11-05", "1234567890", "platinum", TRUE),
...
INSERT INTO dependents
    (`main_member_id`, `dependent_id
`, `name`, `birth_date`, `relationship`)
VALUES
(1, 1, "Hannah Thornock", "2004-01-07", "Girlfriend"),
...
VALUES
("EQ12345", "2023-01-01", "Treadmill calibration and belt adjustment", 5),
...
INSERT INTO snack_purchase
    (`member_id`, `product_id
`, `quantity`, `total_price`, `purchase_date`, 'employee_id')
VALUES
(1, 1, 2, 5.00, "2023-01-02", 9),
...
INSERT INTO trainer_session
    (trainer_id, member_id, session_date, session_time, duration_minutes)
VALUES
    (1, 1, '2025-07-01', '09:00:00', 60),
